...
import sim.engine.client.sendInventoryItems
...
import sim.engine.inv.remove.ShopItemAmountBounds
import sim.engine.inv.restrict.ItemRestrictionRule
import sim.engine.inv.restrict.ShopRestrictions
import sim.engine.inv.stack.AlwaysStack
import sim.engine.inv.stack.ItemStackingRule
import sim.engine.inv.stack.NeverStack
...
fun Player.carriesItem(id: String) = inventory.contains(id) || equips(id)

fun Player.carriesItem(id: String, amount: Int) = inventory.contains(id, amount) || equips(id, amount)

fun Player.equips(id: String) = equipment.contains(id)

fun Player.equips(id: String, amount: Int) = equipment.contains(id, amount)
