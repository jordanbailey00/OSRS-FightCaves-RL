...
import sim.config.ConfigReader
import sim.engine.data.config.CombatDefinition
import sim.engine.data.config.CombatDefinition.CombatAttack
import sim.engine.data.config.CombatDefinition.CombatHit
import sim.engine.data.config.CombatDefinition.Projectile
import sim.engine.data.config.CombatDefinition.Origin
