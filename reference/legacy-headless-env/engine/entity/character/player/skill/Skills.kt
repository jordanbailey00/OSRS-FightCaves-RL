package sim.engine.entity.character.player.skill
...
interface Skills {
    ...
    companion object : AutoCloseable {
        ...
        fun hasNpcLevelChangedHandler(id: String, skill: Skill): Boolean =
            npcChanged.containsKey("$id:${skill.name}") || npcChanged.containsKey("*:${skill.name}")
