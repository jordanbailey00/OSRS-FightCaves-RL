...
internal class VariableDefinitionTest {
    ...
    fun setup() {
        ...
        mockkStatic("sim.network.login.protocol.encode.VarpEncoderKt")
        mockkStatic("sim.network.login.protocol.encode.VarbitEncoderKt")
        mockkStatic("sim.network.login.protocol.encode.VarcEncoderKt")
        mockkStatic("sim.network.login.protocol.encode.VarcStrEncoderKt")
    }
