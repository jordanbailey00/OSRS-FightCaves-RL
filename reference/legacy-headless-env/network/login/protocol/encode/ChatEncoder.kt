...
import sim.network.client.Client.Companion.name
import sim.network.client.Client.Companion.smart
import sim.network.client.Client.Companion.string
import sim.network.login.Protocol.GAME_MESSAGE
import sim.network.login.Protocol.PRIVATE_CHAT_FROM
import sim.network.login.Protocol.PRIVATE_CHAT_TO
import sim.network.login.Protocol.PRIVATE_QUICK_CHAT_FROM
import sim.network.login.Protocol.PRIVATE_QUICK_CHAT_TO
import sim.network.login.Protocol.PUBLIC_CHAT
