...
class Tarquin : Script {
    ...
    init {
        npcOperate("Talk-To", "tarquin") {
            ...
            npc<Bored>("Hello old bean. Is there something I can help you with?")
            choice {
                option<Idle>("Who are you?") {
                    npc<Bored>("My name is Tarquin Marjoribanks.")
                    npc<Idle>("I'd be surprised if you haven't already heard of me?")
                    player<Quiz>("Why would I have heard of you Mr. Marjoribanks?")
                    npc<Frustrated>("It's pronounced 'Marchbanks'!")
                    npc<Idle>("You should know of me because I am a member of the royal family of Misthalin!")
                    player<Quiz>("Are you related to King Roald?")
                    npc<Happy>("Oh yes! Quite closely actually")
                    npc<Idle>("I'm his 4th cousin, once removed on his mothers side.")
                    player<Confused>("Er... Okay. What are you doing here then?")
                    npc<Idle>("I'm canoeing on the river! It's enormous fun! Would you like to know how?")
                    choice {
                        option("Yes") {
                            canoeing()
                        }
    ...
    suspend fun Player.canoeing() {
        ...
        npc<Bored>("Of course there are other canoes.")
        when (levels.get(Skill.Woodcutting)) {
            in 12..26 -> {
                npc<Shock>("Further up river, near the Barbarian Village, I saw some darned fool 'canoeing' on a log!")
                npc<Bored>("Unfortunately, you don't have the skill to create anything more than one of those logs. I dare say it will only get 1 stop down the river!")
                npc<Bored>("Still, I'm sure it will satisfy one such as yourself.")
                ...
                player<Shock>("Pfft! I doubt he even knows the King!")
            }
            in 27..41 -> {
                npc<Happy>("You seem to be quite handy with an axe though!")
                npc<Bored>("I'm sure you can build a Dugout canoe. Not as fine as a Stable Dugout but it will carry you 2 stops on the river.")
                npc<Bored>("I should imagine it would suit your limited means.")
                player<Frustrated>("What do you mean when you say 'limited means'?")
                npc<Shock>("Well, you're just an itinerant adventurer!")
            ...
            in 42..56 -> {
                ...
                npc<Idle>("If you were of good pedigree I'd let you join my boat club. You seem to be one of those vagabond adventurers though.")
                ...
                npc<Happy>("A Stable Dugout canoe will take you pretty much the length of the Lum river.")
                npc<Bored>("Of course there are other canoes.")
                npc<Shock>("Well ... erm. You seem to be able to make a Waka!")
                player<Happy>("Sounds fun, what's a Waka.")
                npc<Idle>("I've only ever seen one man on the river who uses a Waka. A big, fearsome looking fellow up near Edgeville.")
                npc<Quiz>("People say he was born in the Wilderness and that he is looking for a route back.")
                player<Shock>("Is that true!")
                npc<Bored>("How should I know? I would not consort with such a base fellow!")
            }
        }
    }
}
