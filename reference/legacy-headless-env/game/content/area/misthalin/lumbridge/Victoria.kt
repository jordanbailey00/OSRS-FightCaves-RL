...
class Victoria : Script {
    ...
    init {
        npcOperate("Talk-to", "victoria") {
            ...
            choice("What would you like to say?") {
                option<Idle>("Yes, I've seen Lachtopher.") {
                    npc<Disheartened>("Ah, he'll have asked you for money, no doubt. I hope you didn't give him any.")
                    choice("What would you like to say?") {
                        ...
                        option<Happy>("Yes, I loaned him money, just like he asked.") {
                            npc<Disheartened>("Oh dear. I'm sorry to tell you this, but that's the last you'll see of that money. My brother is such a waste of space. I've been lending him things for years and he never gives them back.")
                            timesChange()
                        }
                    }
                }
                option<Idle>("No, I haven't seen him.") {
                    npc<Happy>("Well, if you do meet him, he'll ask you for money, no doubt. Please don't give him any.")
                    player<Quiz>("Why not?")
                    npc<Disheartened>("Sorry to tell you this, but if you lend him money you'll never see it again. My brother is such a waste of space. I've been lending him things for years and he never gives them back.")
                    timesChange()
                }
            }
        }
    ...
    suspend fun Player.timesChange() {
        ...
        npc<Disheartened>("Yes, but it never used to be this bad. You see...")
        ...
        npc<Disheartened>("Then, one day, the Duke told us it was no longer safe to live on the east riverbank, so some villagers had to move across here.")
        npc<Disheartened>("With no money for lodgings, and nowhere else to go, Lachtopher came to live with me. I've only a small house, so he sleeps downstairs on the floor.")
        player<Shock>("Goodness. That sounds quite uncomfortable.")
        npc<Angry>("Not uncomfortable enough, it seems.")
        npc<Disheartened>("I thought he'd only be staying for a couple of weeks, just until he'd got some money together, but he's been here for ages now.")
        player<Quiz>("So, why not just throw him out on to the streets?")
        npc<Shock>("Oh, no! I couldn't do that to my brother.")
