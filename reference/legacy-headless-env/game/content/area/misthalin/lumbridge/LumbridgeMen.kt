    ...
    init {
        npcOperate("Talk-to", "lumbridge_man*,lumbridge_woman*") {
            ...
            when (random.nextInt(0, 15)) {
                0 -> npc<Disheartened>("I have to go all the way through the swamp to go mining. My poor feet!")
                1 -> npc<Disheartened>("Hello. I'm Sorry to say that Lumbridge is not what it once was.")
                ...
                11 -> npc<Disheartened>("Don't come near me, I have a cold!")
