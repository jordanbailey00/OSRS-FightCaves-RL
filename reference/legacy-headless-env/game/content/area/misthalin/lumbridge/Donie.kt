...
class Donie : Script {
    ...
    fun ChoiceOption.whereAmI(): Unit = option<Quiz>("Where am I") {
        npc<Laugh>("This is the town of Lumbridge my friend.")
        choice {
            howToday()
            anyQuests()
            shoeLace()
    ...
    fun ChoiceOption.howToday(): Unit = option<Quiz>("How are you today?") {
        ...
        player<Laugh>("Weather?")
        npc<Laugh>("Yes weather, you know.")
        ...
        player<Quiz>("...")
        npc<Laugh>("Not just a pretty face eh? Ha ha ha.")
    }
    ...
    fun ChoiceOption.anyQuests(): Unit = option<Quiz>("Are there any quests I can do here?") {
        ...
        choice {
            option<Happy>("I fancy a bit of fight, anything dangerous?") {
                ...
                choice {
                    option<Happy>("Big scary demons!") {
                        npc<Laugh>("You are a brave soul indeed.")
                        npc<Confused>("Now that you mention it, I heard a rumour about a fortune-teller in Varrock who is rambling about some kind of grater evil.. sounds demon-like if you ask me.")
                        npc<Quiz>("Perhaps you could check it out if you are as brave as you say?")
                        if (questCompleted("demon_slayer")) {
                            player<Laugh>("I've already killed the demon Delrith. He was merely a stain on my sword when I was finished with him!")
                    ...
                    option<Amazed>("Vampyres!") {
                        npc<Laugh>("Ha ha. I personally don't believe in such things. However, there is a man in Draynor Village who has been scaring the village folk with stories of vampyres.")
                        ...
                        if (questCompleted("vampire_slayer")) {
                            player<Laugh>("Oh i have already killed that nasty blood-sucking vampyre. Draynor will be safe now.")
                            npc<Laugh>("Yeah, yeah of course you did. Everyone knows vampyres are not real...")
                            player<Angry>("What! I did slay the beast..I really did.")
                            npc<Laugh>("You're not fooling anyone you know.")
            ...
            option<Happy>("Something easy please, I'm new here.") {
                ...
                npc<Confused>("The Lumbridge cook has been having problems and the Duke is confused over some strange rocks")
                choice("Tell me about..") {
                    option("The Lumbridge cook.") {
                        player<Happy>("Tell me about the Lumbridge cook.")
                        npc<Laugh>("It's funny really, the cook would forget his head if it wasn't screwed on. This time he forgot to get ingredients for the Duke's birthday cake.")
            ...
            option<Happy>("I'm a thinker rather than a fighter, anything skill oriented?") {
                npc<Confused>("Skills play a big part when you want to progress in knowledge. I know of a few skill-related quests that can get you started.")
                ...
                choice("Tell me about..") {
                    option("Fred the farmer.") {
                        ...
                        npc<Confused>("You can find Fred next to the field of sheep in Lumbridge. Perhaps you should go and speak with him.")
                        if (questCompleted("sheep_shearer_miniquest")) {
                            ...
                            player<Disheartened>("He wouldn't let me kill his chickens though.")
                            npc<Laugh>("Lumbridge chickens do make good target practice.")
                ...
                choice("Tell me about..") {
                    option("Hetty the witch.") {
                        ...
                        if (questCompleted("witches_potion_miniquest")) {
                            ...
                            npc<Scared>("Did she really?")
                            player<Laugh>("No, not really.")
                            npc<Angry>("Right...")
                        } else {
                    ...
                    option("Pirate's Treasure.") {
                        ...
                        if (questCompleted("pirates_treasure")) {
                            ...
                            npc<Laugh>("Yarr indeed my friend. A most excellent find.")
                            player<Angry>("Yarr!")
                            npc<Laugh>("Yarrr!")
                            player<Angry>("YARRR!")
                            npc<Angry>("Right, that's enough of that!")
                            player<Disheartened>("..Sorry.")
                        } else {
    ...
    fun ChoiceOption.shoeLace(): Unit = option<Laugh>("Your shoe lace is untied.") {
        npc<Angry>("No it's not!")
        player<Laugh>("No you're right. I have nothing to back that up.")
    ...
    fun ChoiceOption.buyStick(): Unit = option<Quiz>("Can i buy your stick?") {
        ...
        npc<Disheartened>("Um..It's a bit low on power at the moment..")
        player<Laugh>("It's a stick isn't it?")
        npc<Disheartened>("...Ok it's a stick.. But only while I save up for a staff. Zaff in Varrock square sells them in his shop.")
        player<Laugh>("Well good luck with that.")
    }
    ...
    fun ChoiceOption.hairCut(): Unit = option<Quiz>("Where can I get a haircut like yours?") {
        ...
        npc<Laugh>("No problem. The hairdresser in Falador will probably be able to sort you out.")
