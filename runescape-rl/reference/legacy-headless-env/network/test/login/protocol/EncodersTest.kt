...
import sim.network.client.IsaacCipher
import sim.network.login.protocol.encode.*
import sim.network.login.protocol.encode.zone.*
import java.io.File
import kotlin.random.Random

class EncodersTest {

    private val zonePackets = File("./test-resources/encoder-zone-packets.csv")
        .readLines()
    ...
    private val packets = File("./test-resources/encoder-packets.csv")
        .readLines()
        .map { line ->
