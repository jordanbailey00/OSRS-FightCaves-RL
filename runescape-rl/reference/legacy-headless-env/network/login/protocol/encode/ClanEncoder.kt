...
import sim.network.login.Protocol.APPEND_CLAN_CHAT
import sim.network.login.Protocol.CLAN_CHAT
import sim.network.login.Protocol.CLAN_QUICK_CHAT
import sim.network.login.Protocol.UPDATE_CLAN_CHAT
