...
[run_history.md](/home/joe/projects/runescape-rl/codex3/runescape-rl/docs/run_history.md).
...
Those files currently represent the trimmed live config surface used by the
late `v25` line. The scalar values match the `v25.5a` live recipe.
...
- `shape_jad_kill_bonus`
  Extra reward on the tick Jad dies, in addition to `w_jad_kill`.
