...
> Legacy detailed RL spec retained for deep reference.
> Canonical module docs are `training-env/README.md`, `training-env/SPEC.md`, `training-env/ARCHITECTURE.md`, and `training-env/PARITY.md`.
> Canonical cross-workspace truth lives under `docs/active-reference/*` and `docs/source-of-truth/*`.
