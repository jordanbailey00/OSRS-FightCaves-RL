...
def resolve_checkpoint_path(explicit: Path | None) -> Path:
    ...
    candidates = (
        runtime_subdir(
            ...
            "rl",
            "acceptance",
            "pr52_wsl_acceptance_20260311",
            "train_run",
            "fc-rl-train-1773247469-b81341f34265.pt",
        ),
        runtime_subdir(
            "artifacts",
            "training-env",
            ...
            "disabled",
            "run_data",
            "fc-rl-train-1773246426-dc100d1bb7c4.pt",
        ),
        runtime_subdir(
            "artifacts",
            "training-env",
            ...
            "standard",
            "run_data",
            "fc-rl-train-1773243116-da2d2e385d61.pt",
        ),
    )
