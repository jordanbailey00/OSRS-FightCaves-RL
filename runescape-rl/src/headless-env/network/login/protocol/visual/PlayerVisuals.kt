...
import sim.network.login.protocol.visual.VisualMask.MOVEMENT_TYPE_MASK
import sim.network.login.protocol.visual.VisualMask.TEMPORARY_MOVEMENT_TYPE_MASK
import sim.network.login.protocol.visual.update.player.Appearance
import sim.network.login.protocol.visual.update.player.Body
import sim.network.login.protocol.visual.update.player.MovementType
