package sim.engine.entity.character.mode.combat
...
interface CombatApi {
    ...
    companion object : AutoCloseable {
        ...
        fun hasNpcAttackHandler(npc: String, attack: String): Boolean = npcAttack.containsKey("$npc:$attack")

        fun hasNpcConditionHandler(condition: String): Boolean = npcCondition.containsKey(condition)

        fun hasNpcDamageHandler(npc: String, style: String = "*"): Boolean =
            damageNpc.containsKey("$npc:$style") || damageNpc.containsKey("*:$style") || damageNpc.containsKey("$npc:*") || damageNpc.containsKey("*:*")
