...
interface TimerApi {
    ...
    companion object : AutoCloseable {
        ...
        fun hasNpcTimerStartHandler(timer: String): Boolean = npcStart.containsKey(timer)

        fun hasNpcTimerTickHandler(timer: String): Boolean = npcTick.containsKey(timer)
