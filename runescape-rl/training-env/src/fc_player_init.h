 ...
 *                                      ----     ----     ----  ----  ----  ----  ----   ----
 *   TOTAL                               215       99      115   104   129   148   111      9
 */
...
static const FcLoadout FC_LOADOUTS[FC_NUM_LOADOUTS] = {
    ...
    /* [1] Loadout B: End-game — Masori (f) + Twisted Bow */
    {
        ...
        .def_stab     = 115,   /* 8+0+0+0+59+35+8+5+0+0 */
        .def_slash    = 104,   /* 10+0+0+0+52+30+7+5+0+0 */
        .def_crush    = 129,   /* 12+0+0+0+64+39+9+5+0+0 */
