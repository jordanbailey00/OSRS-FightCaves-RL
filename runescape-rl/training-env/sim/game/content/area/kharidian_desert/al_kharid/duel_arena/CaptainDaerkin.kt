...
class CaptainDaerkin : Script {
    ...
    init {
        npcOperate("Talk-to", "captain_daerkin") {
            ...
            player<Idle>("What are you doing here? Shouldn't you be looking after your glider?")
            ...
            player<Idle>("You're watching the duels then. Are you going to challenge someone yourself?")
            ...
            player<Idle>("Errm, I suppose you are.")
        }
    }
}
